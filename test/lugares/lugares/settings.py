"""
Django settings for lugares project.
...
SECRET_KEY = 'django-insecure-sw*3ck4h*1qz+^fcorww0smw^d347)14p!g7v(+aw)qgcxnzfx'
...
INSTALLED_APPS = [
    'lugares', 'oauth2_provider', 'sloth.api', 'sloth.app',
    'django.contrib.auth',
...
WSGI_APPLICATION = 'lugares.wsgi.application'
