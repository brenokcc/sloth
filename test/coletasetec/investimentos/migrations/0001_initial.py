# Generated by Django 4.1 on 2023-03-28 11:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teto', sloth.db.models.DecimalField(decimal_places=2, max_digits=15, verbose_name='Limite Orçamentário (R$)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('descricao', sloth.db.models.CharField(max_length=512, verbose_name='Descrição')),
                ('valor_total', sloth.db.models.DecimalField(decimal_places=2, max_digits=15, null=True, verbose_name='Valor Total (R$)')),
                ('valor', sloth.db.models.DecimalField(decimal_places=2, max_digits=15, null=True, verbose_name='Valor a Empenhar no Exercício (R$)')),
                ...
                ('classificacao', sloth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='investimentos.categoria', verbose_name='Categoria')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('resposta', sloth.db.models.TextField(null=True, verbose_name='Resposta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalhe_rco_pendente', sloth.db.models.TextField(blank=True, null=True, verbose_name='Detalhe de RCO Pendente')),
                ('devolucao_ted', sloth.db.models.CharField(choices=[['', ''], ['Sim', 'Sim'], ['Não', 'Não']], max_length=255, verbose_name='Devolução de TED')),
                ('detalhe_devolucao_ted', sloth.db.models.TextField(blank=True, null=True, verbose_name='Detalhe de Devolução de TED')),
                ...
                ('prioridade_1', sloth.db.models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r1', to='investimentos.demanda', verbose_name='Prioridade 1')),
                ('prioridade_2', sloth.db.models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r2', to='investimentos.demanda', verbose_name='Prioridade 2')),
                ('prioridade_3', sloth.db.models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r3', to='investimentos.demanda', verbose_name='Prioridade 3')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introducao', sloth.db.models.TextField(verbose_name='Introdução')),
                ('detalhamento', sloth.db.models.TextField(verbose_name='Detalhamento')),
                ('anexos', sloth.db.models.OneToManyField(to='investimentos.anexo', verbose_name='Anexos')),
                ('notificados', sloth.db.models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Notificados')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', sloth.db.models.CharField(max_length=255, verbose_name='Nome')),
                ('email', sloth.db.models.CharField(max_length=255, null=True, verbose_name='E-mail')),
                ('instituicao', sloth.db.models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='investimentos.instituicao', verbose_name='Instituição')),
            ],
            options={
                'verbose_name': 'Gestor ',
                'verbose_name_plural': 'Gestores',
                'fieldsets': {'Dados Gerais': (('nome', 'email'), 'instituicao')},
            },
            bases=(models.Model, sloth.core.base.ModelMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pergunta', sloth.db.models.TextField(verbose_name='Pergunta')),
                ...
                ('instituicao', sloth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='investimentos.instituicao', verbose_name='Instituição')),
            ],
            options={
                'verbose_name': 'Dúvida',
        ...
        migrations.AddField(
            ...
            field=sloth.db.models.ManyToManyField(blank=True, help_text='Não informar caso todas as unidades sejam beneficiadas.', to='investimentos.campus', verbose_name='Unidades Beneficiadas'),
        ),
        migrations.AddField(
            model_name='ciclo',
            name='instituicoes',
            field=sloth.db.models.ManyToManyField(blank=True, help_text='Não informar, caso deseje incluir todas as instituições.', to='investimentos.instituicao', verbose_name='Demandantes'),
        ),
        migrations.AddField(
            model_name='ciclo',
            name='limites',
