"""
Django settings for renderers project.
...
SECRET_KEY = 'django-insecure-r^9q57a_e$ca3&i^u-#7%)waah_m@prv$xape_00w+tmz9s=*r'
...
WSGI_APPLICATION = 'renderers.wsgi.application'
