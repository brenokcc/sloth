...
class TestCase(ServerTestCase):
    ...
    def test(self):
        ...
        self.assertEquals(response['append']['get_total_pessoas_por_sexo']['template'], 'charts/donut.html')
        ...
        self.assertEquals(response['append']['get_total_pessoas_casadas']['template'], 'charts/column.html')
