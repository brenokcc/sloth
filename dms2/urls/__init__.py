...
urlpatterns = [
    ...
    path('adm/<str:app_label>/<str:model_name>/<str:x>/<str:y>/<str:z>/<str:w>/', adm.obj_view),
    path('adm/<str:app_label>/<str:model_name>/<str:x>/<str:y>/<str:z>/', adm.obj_view),
    path('adm/<str:app_label>/<str:model_name>/<str:x>/<str:y>/', adm.obj_view),
    ...
    path('api/<str:app_label>/<str:model_name>/<str:x>/<str:y>/<str:z>/<str:w>/', api.obj_view),
