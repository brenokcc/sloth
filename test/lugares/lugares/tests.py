...
class TestCase(ServerTestCase):
    ...
    def _test_meta(self):
        ...
        self.assertEquals(response['data']['get_total_pessoas_por_sexo']['auxiliary'], True)
        self.assertEquals(response['data']['get_total_pessoas_por_sexo']['type'], 'statistics')
        self.assertEquals(response['data']['get_total_pessoas_por_sexo']['path'], '/meta/dashboard/lugares/pais/1/get_estados/1/get_cidades/1/get_total_pessoas_por_sexo/')
        self.assertEquals(response['data']['get_total_pessoas_por_sexo']['template'], 'charts/donut.html')
        self.assertEquals(response['data']['get_total_pessoas_casadas']['auxiliary'], True)
        self.assertEquals(response['data']['get_total_pessoas_casadas']['type'], 'statistics')
        self.assertEquals(response['data']['get_total_pessoas_casadas']['path'], '/meta/dashboard/lugares/pais/1/get_estados/1/get_cidades/1/get_total_pessoas_casadas/')
        self.assertEquals(response['data']['get_total_pessoas_casadas']['template'], 'charts/column.html')
        self.assertEquals(response['metadata']['attach'][0]['name'], 'Estatisticas')
        ...
        self.assertEquals(response['data']['get_total_por_sexo']['type'], 'statistics')
        self.assertEquals(response['data']['get_total_por_sexo']['path'], '/meta/dashboard/lugares/pessoa/get_total_por_sexo/')
        self.assertEquals(response['data']['get_total_casadas']['type'], 'statistics')
        self.assertEquals(response['data']['get_total_casadas']['path'], '/meta/dashboard/lugares/pessoa/get_total_casadas/')
        self.assertEquals(response['metadata']['attach'][0]['name'], 'Total por Sexo Casado')
        self.assertEquals(response['metadata']['attach'][0]['path'], '/meta/dashboard/lugares/pessoa/get_total_por_sexo_casado/')
